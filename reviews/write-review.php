...
if (isset($_POST['submit'])) {
    if (
        ...
        $writeReview = $conn->prepare(
            "INSERT INTO reviews (review, username) VALUES (:review, :username)"
        );
                    ...
                    <div class="row align-items-end">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input name="review" type="text" class="form-control" placeholder="Write Review" required>
                            </div>
                        </div>
